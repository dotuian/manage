...
return array (
  ...
  'You are not authorized to perform this action.' => '您未被授权执行这个功能！',
  ...
  '{attribute} is not in the list.' => '{attribute}的值不合理！',
  ...
  '{attribute} is too long (maximum is {max} characters).' => '{attribute}的长度必须在{max}字符以下！',
  '{attribute} is too short (minimum is {min} characters).' => '{attribute}的长度必须在{min}字符以上！',
