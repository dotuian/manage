...
class ReportForm extends CFormModel {
    ...
    public function rules() {
        ...
        return array(
            ...
            array('entry_year, grade, exam_id, subject_id, class_id, class_type', 'safe'),
        );
    }
    ...
    public function getExcelData() {
        ...
        $sql .= " (select aa.class_code from t_classes aa, t_student_classes bb where aa.ID=bb.class_id and bb.student_id=d.ID order by bb.create_time asc limit 0, 1) as new_class_code, "; // 班级(现)
        $sql .= " (select aa.class_code from t_classes aa, t_student_classes bb where aa.ID=bb.class_id and bb.student_id=d.ID order by bb.create_time asc limit 1, 1) as old_class_code "; // 班级(原)
        $sql .= "FROM t_scores a  ";
