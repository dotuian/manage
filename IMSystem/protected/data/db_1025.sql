GRANT ALL PRIVILEGES ON xsglxtsql.* TO 'xsglxtsql'@'localhost'
  IDENTIFIED BY 'p5FtKwWmEWb95pKH' ；
...
INSERT INTO `m_config` (`ID`, `key`, `value`, `comment`) VALUES
	(1, 'IMPORT_STUDENT_DATA_RANGE', '2014-10-07|2014-10-05', NULL),
	(2, 'IS_RUNNING', '1', NULL);
