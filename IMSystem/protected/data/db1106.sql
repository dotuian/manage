...
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='学生信息表';

-- Dumping data for table xsglxtsql.t_students: ~3 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `t_student_classes` (
  ...
  `update_time` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `student_number_student_id_class_id` (`student_number`,`student_id`,`class_id`),
...
-- Dumping data for table xsglxtsql.t_student_classes: ~8 rows (approximately)
...
-- Dumping data for table xsglxtsql.t_teachers: ~17 rows (approximately)
...
-- Dumping data for table xsglxtsql.t_teacher_subjects: ~23 rows (approximately)
...
INSERT INTO `t_users` (`ID`, `username`, `password`, `status`, `last_login_time`, `last_password_time`, `create_user`, `create_time`, `update_user`, `update_time`) VALUES
	(1, 'root', 'rootadmin1', '1', '2014-11-06 13:29:13', '2014-11-05 12:08:13', 0, '2014-10-22 15:01:57', 1, '2014-11-05 12:08:13'),
...
-- Dumping data for table xsglxtsql.t_user_roles: ~22 rows (approximately)
