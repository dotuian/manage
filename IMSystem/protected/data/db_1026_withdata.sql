...
-- 正在导出表  xsglxtsql.m_authoritys 的数据：~39 rows (大约)
...
INSERT INTO `m_config` (`ID`, `key`, `value`, `comment`) VALUES
	(1, 'IMPORT_STUDENT_DATA_RANGE', '2014-09-29|2014-10-05', NULL),
	(2, 'IS_RUNNING', '1', NULL);
...
-- 正在导出表  xsglxtsql.m_role_authoritys 的数据：~108 rows (大约)
...
INSERT INTO `m_subjects` (`ID`, `subject_code`, `subject_name`, `subject_short_name`, `subject_type`, `status`, `level`, `create_user`, `create_time`, `update_user`, `update_time`) VALUES
	...
	(10, 'aaaaaaaaaa', 'aaaaaaaaaa', 'aaaa', '1', '2', 0, 1, '2014-10-26 09:58:55', 1, '2014-10-26 10:20:49');
...
-- 正在导出表  xsglxtsql.t_classes 的数据：~7 rows (大约)
...
INSERT INTO `t_classes` (`ID`, `class_code`, `class_name`, `class_type`, `specialty_name`, `status`, `term_year`, `teacher_id`, `create_user`, `create_time`, `update_user`, `update_time`) VALUES
	(1, 'C0001', '高一(1)', '0', NULL, '2', 2014, 8, 0, '2014-09-23 17:17:22', 1, '2014-10-25 21:20:04'),
	(2, 'C0002', '高一(2)', '0', NULL, '1', 2014, NULL, 0, '2014-09-23 17:17:22', 0, '2014-09-23 17:17:22'),
	(3, 'C0003', '高二(1)', '0', NULL, '1', 2013, NULL, 0, '2014-09-23 17:17:22', 0, '2014-09-23 17:17:22'),
	(4, 'C0004', '高二(2)', '0', NULL, '1', 2013, NULL, 0, '2014-09-23 17:17:22', 0, '2014-09-23 17:17:22'),
	(5, 'C0005', '高三(1)', '0', NULL, '2', 2012, NULL, 0, '2014-09-23 17:17:22', 0, '2014-10-17 23:19:03'),
	(6, 'C0006', '高三(2)', '0', NULL, '1', 2012, NULL, 0, '2014-09-23 17:17:22', 0, '2014-10-02 15:33:09'),
	(7, '212', '班级名称班级名称班级名称班级名称班级名称', '0', '班级名称班级名称班级名称班级名称班级名称', '1', 2014, 6, 1, '2014-10-26 09:49:37', 1, '2014-10-26 09:50:03');
...
-- 正在导出表  xsglxtsql.t_scores 的数据：~17 rows (大约)
...
INSERT INTO `t_students` (`ID`, `code`, `name`, `status`, `sex`, `id_card_no`, `birthday`, `accommodation`, `payment1`, `payment2`, `payment3`, `payment4`, `payment5`, `payment6`, `bonus_penalty`, `address`, `parents_tel`, `parents_qq`, `school_of_graduation`, `senior_score`, `school_year`, `college_score`, `university`, `comment`, `create_user`, `create_time`, `update_user`, `update_time`) VALUES
	(9, '20140001', '20140001', '1', 'M', '420984198605252712', '2014-09-16', '', '0', '0', '0', '0', '0', '0', '', '', '', '', '', NULL, NULL, NULL, '', '', 1, '2014-10-24 14:29:02', 1, '2014-10-24 14:57:03');
...
INSERT INTO `t_student_classes` (`ID`, `student_id`, `class_id`, `status`, `create_user`, `create_time`, `update_user`, `update_time`) VALUES
	...
	(4, 9, 1, '2', 1, '2014-10-24 14:57:03', 1, '2014-10-25 21:23:29'),
	(5, 9, 3, '1', 1, '2014-10-25 21:23:29', 1, '2014-10-25 21:23:29');
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='教师表';

-- 正在导出表  xsglxtsql.t_teachers 的数据：~15 rows (大约)
...
) ENGINE=InnoDB AUTO_INCREMENT=20 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='教师表';

-- 正在导出表  xsglxtsql.t_teacher_subjects 的数据：~19 rows (大约)
...
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='用户表';

-- 正在导出表  xsglxtsql.t_users 的数据：~15 rows (大约)
DELETE FROM `t_users`;
...
INSERT INTO `t_users` (`ID`, `username`, `password`, `status`, `create_user`, `create_time`, `update_user`, `update_time`) VALUES
	...
	(9, '20140001', 'test1234', '1', 1, '2014-10-24 14:29:02', 1, '2014-10-24 14:29:02'),
	(10, 'sx001', 'test1234', '1', 1, '2014-10-24 15:01:47', 10, '2014-10-24 15:22:35'),
	(11, 'sw001', '20141021', '1', 1, '2014-10-24 15:02:15', 1, '2014-10-24 15:02:15'),
	(12, 'yy001', '20141021', '1', 1, '2014-10-24 15:02:44', 1, '2014-10-24 15:02:44'),
	(13, 'wl001', '20141007', '1', 1, '2014-10-24 15:28:23', 1, '2014-10-24 15:28:23'),
	(14, 'hx01', '20141019', '1', 1, '2014-10-24 15:28:43', 1, '2014-10-24 15:28:43'),
	(15, 'zz01', '20141008', '1', 1, '2014-10-24 15:29:07', 1, '2014-10-24 15:29:07'),
	(16, 'ls01', '20141013', '1', 1, '2014-10-24 15:29:50', 1, '2014-10-24 15:29:50'),
	(17, 'dl01', '20141009', '1', 1, '2014-10-24 15:30:11', 1, '2014-10-24 15:30:11'),
	(20, 'dl02', '20141009', '1', 1, '2014-10-24 15:38:09', 1, '2014-10-24 15:38:09'),
	(21, 'qn01', '20141006', '1', 1, '2014-10-24 15:38:45', 1, '2014-10-24 15:38:45');
...
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='用户角色表';

-- 正在导出表  xsglxtsql.t_user_roles 的数据：~18 rows (大约)
