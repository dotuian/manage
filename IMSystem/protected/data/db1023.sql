...
-- Dumping data for table xsglxtsql.m_authoritys: ~38 rows (approximately)
...
-- Dumping data for table xsglxtsql.m_role_authoritys: ~207 rows (approximately)
...
-- Dumping data for table xsglxtsql.t_teachers: ~4 rows (approximately)
...
-- Dumping data for table xsglxtsql.t_users: ~4 rows (approximately)
DELETE FROM `t_users`;
...
-- Dumping data for table xsglxtsql.t_user_roles: ~4 rows (approximately)
