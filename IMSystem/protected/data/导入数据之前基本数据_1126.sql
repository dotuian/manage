...
) ENGINE=InnoDB AUTO_INCREMENT=134 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='角色权限表';

-- Dumping data for table xsglxtsql.m_role_authoritys: ~84 rows (approximately)
...
INSERT INTO `t_users` (`ID`, `username`, `password`, `status`, `last_login_time`, `last_password_time`, `create_user`, `create_time`, `update_user`, `update_time`) VALUES
	(1, 'root', 'rootadmin', '1', '2014-11-25 12:56:21', NULL, 0, '2014-11-14 17:55:57', NULL, NULL);
